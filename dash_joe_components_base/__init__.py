...
if not hasattr(_dash.development.base_component, '_explicitize_args'):
    print("Please update the `dash` module to >= 0.23.1 to use this "
          "version of dash_joe_components.\n"
...
_js_dist.extend([{
    ...
    'external_url': (
        ...
        '/dash_joe_components/async-{}.js'
    ).format(__version__, async_resource),
    'namespace': 'dash_joe_components',
    'async': True
...
_js_dist.extend([{
    ...
    'external_url': (
        'https://unpkg.com/dash-core-components@{}'
        '/dash_joe_components/async-{}.js.map'
    ).format(__version__, async_resource),
    'namespace': 'dash_joe_components',
    'dynamic': True
} for async_resource in async_resources])
...
_js_dist.extend([
    {
        ...
        'external_url': (
            'https://unpkg.com/dash-core-components@{}'
            '/dash_joe_components/dash_joe_components.min.js'
        ).format(__version__),
        'namespace': 'dash_joe_components'
    },
    {
        ...
        'external_url': (
            'https://unpkg.com/dash-core-components@{}'
            '/dash_joe_components/dash_joe_components.min.js.map'
        ).format(__version__),
        'namespace': 'dash_joe_components',
        'dynamic': True
    },
    {
        ...
        'external_url': (
            'https://unpkg.com/dash-core-components@{}'
            '/dash_joe_components/dash_joe_components-shared.js'
        ).format(__version__),
        'namespace': 'dash_joe_components'
    },
    {
        ...
        'external_url': (
            'https://unpkg.com/dash-core-components@{}'
            '/dash_joe_components/dash_joe_components-shared.js.map'
        ).format(__version__),
        'namespace': 'dash_joe_components',
        'dynamic': True
    },
    {
        ...
        'external_url': (
            'https://unpkg.com/dash-core-components@{}'
            '/dash_joe_components/plotly.min.js'
        ).format(__version__),
        'namespace': 'dash_joe_components',
        'async': 'eager'
    },
    {
        ...
        'external_url': (
            'https://unpkg.com/dash-core-components@{}'
            '/dash_joe_components/async-plotlyjs.js'
        ).format(__version__),
        'namespace': 'dash_joe_components',
        'async': 'lazy'
    },
    {
        ...
        'external_url': (
            'https://unpkg.com/dash-core-components@{}'
            '/dash_joe_components/async-plotlyjs.js.map'
        ).format(__version__),
        'namespace': 'dash_joe_components',
        'dynamic': True
    },
